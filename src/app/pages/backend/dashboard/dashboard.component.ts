...
export class DashboardComponent implements OnInit {
  ...
  // สร้างตัวแปรสำหรับดึงข้อมูลสินค้าแสดงบนฟอร์มแก้ไข
  dataProductEdit = {
    "product_id":"",
    "product_name":"",
    "product_barcode":"",
  ...
  // ฟังก์ชันในการโหลดข้อมูลทั้งหมดแสดงในตาราง
  fatchProduct(){
  ...
  submitAddProduct(){
    this.api.createProduct(this.dataProductAdd).subscribe((data:{}) => {
      ...
      this.fatchProduct(); // โหลดข้อมูลใหม่แสดงในตาราง
      // ปิดหน้าต่าง Modal Add สินค้า
      $("#modalAdd").modal('hide');
      // การเคลียร์ค่าออกจากฟอร์ม
      this.dataProductAdd = {
        "product_name":"",
        "product_barcode":"",
        "product_detail":"",
  ...
  // ฟังก์ชันแสดงหน้าต่างการแก้ไขข้อมูล
  editProduct(id){
    this.api.getProduct(id).subscribe((data:{}) => {
